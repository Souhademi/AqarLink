...
const InvestorLogin = () => {
  ...
  try {
    ...
    if (token && user) {
      ...
      console.log("Stored Investor ID:", userId); // Log the investor ID after storing it
  ...
  //         localStorage.setItem("investorId", user.id);
  ...
  // };
    ...
    return ( 
        ...
        <h2 style = { styles.title } > Welcome back, Investor </h2>
...
<div style = { styles.inputContainer } >
        ...
        <a href = "/investor/forgetPassword"
        style = {
        ...
        <a href = "/investor/create-account"
        style = {
            {...styles.link, color: '#1E5470' } } >
        Register </a> 
        </p> 
